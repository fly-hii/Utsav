...
export function createApp(): Express {
  ...
  app.use('/api/committees/:id/members', memberRoutes);
  app.use('/api/committees/:id/events', eventRoutes);
  app.use('/api/committees/:id/donations', donationRoutes);
  app.use('/api/committees/:id/expenses', expenseRoutes);
  app.use('/api/committees/:id/gallery', galleryRoutes);

  // Standalone Resources
  app.use('/api/events', eventStandaloneRouter);
  app.use('/api/donations', donationStandaloneRouter);
  app.use('/api/expenses', expenseStandaloneRouter);
  app.use('/api/gallery', galleryStandaloneRouter);
